function createProducts (){
    ...
    function makeCopies(img,nam,p,dis,brnd,proddisc,id){
       this.image = img;
       this.name = nam;
       this.price = p;
       this.discount = dis;
       this.brand = brnd;
       this.productDiscount  = proddisc;
       this.id = id;
    }
    ...
    let pro3 = new makeCopies("https://www.lovelula.com/spree/products/4831/product/kimberly-sayer-anti-oxidant-daily-moisturising-cream-spf30-60ml.jpg?1376302530","Kimberly sayer Anti-Oxidant Daily moisturiser Cream",200,15,"Kimberly Sayer",3)
