...
function createElement(el) {
  ...
  // Remove The Item End ---------
    ...
    allPricesSpan.innerHTML = ` <h3 id = "h333">${el.price}</h3> <p id = "priceAndSymbol">&#x20B9 </p>  <br> <br> <p id = "redColor">${el.discount}% off</p> `
...
function takeInput() {
  ...
  if (couponInput.value == "FIRST30" && countForDis == 0) {
    countForDis++;
